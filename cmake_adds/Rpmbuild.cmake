...
# Requires: ${PACKAGE_DEPENDENCY} >= ${PACKAGE_DEPENDENCY_VERSION}
# %description
# ${PACKAGE_DESCRIPTION}
...
MACRO(ADD_RPM RPM_NAME)
  ...
  IF ("${ARGV1}" STREQUAL "")
	...
	COMMAND ${CMAKE_COMMAND} -E echo "Requires: ${PACKAGE_DEPENDENCY} >= ${PACKAGE_DEPENDENCY_VERSION}" >> ${SPEC_FILE}
        ...
        COMMAND ${CMAKE_COMMAND} -E echo "%dir ${RPM_INSTALL_PREFIX}" >> ${SPEC_FILE}
        COMMAND ${CMAKE_COMMAND} -E echo "\"${RPM_INSTALL_PREFIX}/*\"" >> ${SPEC_FILE}
        COMMAND ${CMAKE_COMMAND} -E echo "" >> ${SPEC_FILE}
