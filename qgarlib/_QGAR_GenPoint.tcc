...
template <class T>
GenPoint<T>::GenPoint(const GenPoint<T>& aPt)
...
template <class T>
template <class U>
GenPoint<T>::GenPoint(const GenPoint<U>& aPt)

  : x_(static_cast<T>(aPt.x())),
    y_(static_cast<T>(aPt.y()))
