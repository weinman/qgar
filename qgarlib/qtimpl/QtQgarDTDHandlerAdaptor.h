 ...
 */
DLL_EXPORT   QtQgarDTDHandlerAdaptor(DTDHandler * handler);
 ...
 * @brief Destructor
 */
DLL_EXPORT   virtual ~QtQgarDTDHandlerAdaptor();
//@}
  

DLL_EXPORT   virtual bool notationDecl(const QString& name, 
			    const QString& publicId,
			    const QString& systemId);

DLL_EXPORT   virtual bool unparsedEntityDecl(const QString& name,
				  const QString& publicId,
				  const QString& systemId,
