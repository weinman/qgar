 ...
 */
DLL_EXPORT explicit QIODeviceAdaptor(std::istream * stream);
//@}
 ...
 * @brief Destructor
 */
DLL_EXPORT   virtual ~QIODeviceAdaptor();
//@}
 ...
 * @return always true
 */
DLL_EXPORT   virtual bool open(QIODevice::OpenMode mode);
 ...
 */
DLL_EXPORT   virtual qint64 readData(char * data, qint64 maxlen); 
 ...
 */
DLL_EXPORT   virtual qint64 writeData(const char * data, qint64 len); 
 ...
 */
DLL_EXPORT   virtual bool getChar(char * c);
