 ...
 */
DLL_EXPORT   QtAttributesAdaptor(QXmlAttributes * attributes);
 ...
 * @brief Destructor
 */
DLL_EXPORT   virtual ~QtAttributesAdaptor();
//@}
 ...
 * the list.
 */
DLL_EXPORT   virtual int getIndex(const std::string& qName) const;
 ...
 * the list.
 */
DLL_EXPORT   virtual int getIndex(const std::string& uri, 
 ...
 */
DLL_EXPORT   virtual int getLength() const;
 ...
 */
DLL_EXPORT   virtual std::string getLocalName(int index) const;
 ...
 */  
DLL_EXPORT   virtual std::string getQName(int index) const;
 ...
 */
DLL_EXPORT   virtual std::string getType(int index) const;
 ...
 */
DLL_EXPORT   virtual std::string getType(const std::string& qName) const;
 ...
 * @return The attribute type as a string.
 */
DLL_EXPORT   virtual std::string getType(const std::string& uri, 
			      const std::string& localName) const;
 ...
 * available.
 */
DLL_EXPORT   virtual std::string getURI(int index) const;
 ...
 * out of range.
 */  
DLL_EXPORT   virtual std::string getValue(int index) const;
 ...
 */  
DLL_EXPORT   virtual std::string getValue(const std::string& qName) const;
 ...
 * is not in the list.
 */  
DLL_EXPORT   virtual std::string getValue(const std::string& uri, 
			       const std::string& localName) const;
//@}
