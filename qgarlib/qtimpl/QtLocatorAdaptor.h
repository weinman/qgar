 ...
 */
DLL_EXPORT   QtLocatorAdaptor(QXmlLocator * locator);
 ...
 * @brief Destructor
 */
DLL_EXPORT   virtual ~QtLocatorAdaptor();
...
DLL_EXPORT   virtual int getColumnNumber() const;

DLL_EXPORT   virtual int getLineNumber() const;

DLL_EXPORT   virtual std::string getPublicId() const;

DLL_EXPORT   virtual std::string getSystemId() const;
