 ...
 */
DLL_EXPORT   QtQgarEntityResolverAdaptor(EntityResolver * res);
 ...
 * @brief Destructor
 */
DLL_EXPORT virtual ~QtQgarEntityResolverAdaptor();

//@}

DLL_EXPORT   virtual bool resolveEntity(const QString & publicId, 
