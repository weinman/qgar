...
#include <qgarlib/qtimpl/QtLocatorAdaptor.h>
...
DLL_EXPORT QtQgarContentHandlerAdaptor::QtQgarContentHandlerAdaptor(ContentHandler
							 * handler)
{
  _impl = handler;
  _locatorImpl = 0;
...
DLL_EXPORT QtQgarContentHandlerAdaptor::~QtQgarContentHandlerAdaptor()
{
  delete _locatorImpl;
}
