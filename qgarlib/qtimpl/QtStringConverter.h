...
DLL_EXPORT  static std::string convert(const QString& qtString) 
  {
...
DLL_EXPORT  static QString convert(const std::string& stlString) 
  {
...
DLL_EXPORT  std::string operator()(const QString& qtString)
  {
...
DLL_EXPORT  QString operator()(const std::string& stlString)
  {
